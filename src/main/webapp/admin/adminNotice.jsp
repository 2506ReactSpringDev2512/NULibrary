                        ...
                        <tbody>
                            <c:forEach items="${noticeList}" var="notice">
                                <tr>
                                    ...
                                    <td>
                                        <button onclick="deleteNotice(${notice.noticeNo})" 
                                                style="padding: 5px 10px; border: 1px solid #dc3545; background-color: #dc3545; color: white; cursor: pointer; font-size: 12px;">
                                            삭제
                                        </button>
                                    </td>
                                </tr>
